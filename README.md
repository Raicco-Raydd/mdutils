...
> **v2.3.0** 🎉 Web 编辑器新增 **Vim / Emacs 键位模式**，新手引导完成移动端适配；v2.2.0 上线全新 **日间 / 夜间 / 跟随系统主题切换**（Web 界面），双主题品牌图标（dark / light），线上 WebApp 部署于 Netlify。详见下方「Web 界面」章节。
